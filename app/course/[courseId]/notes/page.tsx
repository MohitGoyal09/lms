...
interface NotesResponse {
  ...
  courseId: string;
  chapterId: number;
  notes: string; // JSON string representing an array with one ChapterNotes object
}
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-gray-50 min-h-screen">
      <div className="flex flex-col items-center gap-6 mb-8">
        {/* Navigation Bar */}
        <div className="w-full bg-white rounded-xl shadow-md p-4 flex items-center justify-between">
          <button
        ...
        {/* Content Card */}
        <div className="w-full bg-white rounded-xl shadow-lg p-8 transition-all duration-300 hover:shadow-xl">
