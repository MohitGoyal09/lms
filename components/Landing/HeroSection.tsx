...
export default function HeroSection() {
  return (
    <div className="relative min-h-[80vh] pt-2 pb-8 overflow-hidden flex flex-col">
      <div className="z-10 flex min-h-8 items-center justify-center mb-2">
      ...
      <div className="container relative px-3 mx-auto max-w-6xl flex-1 flex items-center justify-center">
